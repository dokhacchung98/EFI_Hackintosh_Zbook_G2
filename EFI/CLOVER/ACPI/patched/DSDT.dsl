 ...
 * 
 * Disassembly of DSDT.aml, Tue May 29 15:39:06 2018
 *
...
Return (Package (0x02)
    ...
    OperationRegion (GNVS, SystemMemory, 0x2DF78918, 0x019B)
    ...
    OperationRegion (ASMA, SystemMemory, 0x2DF7A018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0x2DF7C018, 0x10E5)
    ...
    OperationRegion (HPDF, SystemMemory, 0x2DF7EE18, 0x0182)
    ...
    OperationRegion (HPD2, SystemMemory, 0x2DE33F18, 0x006F)
    ...
    OperationRegion (HPBR, SystemMemory, 0x2DF79F18, 0x007E)
...
Return (Local0)
                ...
                Scope (RHUB.PRT0)
                {
                    ...
                    Device (HPT0)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT0._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT0._PLD.VIS_ */
                            }
                    ...
                    Device (HPT1)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT1._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT1._PLD.VIS_ */
                            }
                    ...
                    Device (HPT2)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT2._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT2._PLD.VIS_ */
                            }
                    ...
                    Device (HPT3)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT3._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT3._PLD.VIS_ */
                            }
                    ...
                    Device (HPT4)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT4._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT4._PLD.VIS_ */
                            }
                    ...
                    Device (HPT5)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT5._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT5._PLD.VIS_ */
                            }
            ...
            Scope (\_SB.PCI0.EHC2.RHUB.PRT0.HPT2)
            {
                Device (WCAM)
                {
                    Name (_ADR, 0x03)  // _ADR: Address
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPCP) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT2.WCAM._UPC.UPCP */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        Return (PLDP) /* \_SB_.PCI0.EHC2.RHUB.PRT0.HPT2.WCAM._PLD.PLDP */
                    }
                }
            }
    ...
    IRQNoFlags() { 0, 8, 11, 15 }
            ...
            Device (RP05)
            {
                ...
                Scope (ECF0)
                {
                    Method (_EJD, 0, NotSerialized)  // _EJD: Ejection Dependent Device
                    {
                        Return ("\\_SB.PCI0.EHC1.RHUB.PRT0.HPT6")
                    }
                }
            }
